  ...
  try {
    const res = await fetch(url, {
      ...
      headers: {
        ...
        "user-agent":
          "Mozilla/5.0 (compatible; unclaimed/0.1; +https://github.com/iannuttall/unclaimed)",
...
export async function checkLiveness(domain: string, timeoutMs = 6000): Promise<LivenessResult> {
